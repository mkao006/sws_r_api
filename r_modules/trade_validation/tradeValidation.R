...
## Function to get current selection of trade Data
getSelectedTotalTradeData = function(){}


## Get all the total trade data if to update the model.
getAllTotalTradeData = function(){}
