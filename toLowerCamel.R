##' A naive function to convert character strings to lower camel case.
##'
##' @param string The character string to be converted, can be a
##' vector of strings.
##'
##' @export
...
toLowerCamel = function(string){
    ...
    lowerCamel = sapply(lowerSplitStrings,
        FUN = function(x) paste0(c(x[1], capwords(x[-1])),
            collapse = ""))
    lowerCamel
}
